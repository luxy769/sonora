    ...
    return (
        <Box>
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 4 }}>
                <Avatar
                    src={album.cover_url ? `http://127.0.0.1:8001${album.cover_url}` : '/media/covers/placeholder.jpg'}
                    alt={album.title}
                    sx={{ width: 120, height: 120, mr: 3, boxShadow: '0 4px 16px 0 rgba(34,36,70,0.15)' }}
                />
